...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/08/23 14:52:25 by plogan            #+#    #+#             */
/*   Updated: 2017/08/23 14:52:31 by plogan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "vm.h"

static void		make_or(t_flags *f, t_process *process, int v1, int v2)
{
	int ocp;
	int index;
	int dest;
